...
@AllArgsConstructor
@Builder
public class User { // <<< 2. THÊM "implements UserDetails"
...
//
//        if (this.role == null || this.role.getRole() == null || this.role.getRole().isEmpty()) {
//            return List.of();
//        }
//
//        GrantedAuthority authority = new SimpleGrantedAuthority("ROLE_" + this.role.getRole().toUpperCase());
